...
router.route("/edit/:id").patch(upload.single("profilePic"),requireAdminRole,EditEmployee);
router.route("/changePassword/:id").patch(requireAdminRole,EditEmployeePassword);
